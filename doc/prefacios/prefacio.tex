...
\noindent{\textbf{Resumen}\\
	Comprobamos si podemos obtener conclusiones a partir del estudio de la entropía 
	de las redes de pases de un equipo.
}
\cleardoublepage
...
We check whether we can get conclussions from the study of the passes' network's entropy.
}
\cleardoublepage
