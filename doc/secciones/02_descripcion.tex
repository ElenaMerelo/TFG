...
Como opciones teníamos \href{https://www.python.org/}{Python}, 
...
la cual caracteriza su grado de heterogeneidad (uniformidad) u homogeneidad (variabilidad). Esto es, cuanto más 
cercana sea la distribución de pases a la uniformidad, menos certeza tendremos de quién obtendrá el balón \cite{entropy-analysis}.
...
\href{http://bearcave.com/misl/misl_tech/wavelets/compression/shannon.html}{La entropía de Shannon} nos da 
una manera de estimar el número medio mínimo de \textit{bits} que se necesitan para codificar una cadena de 
símbolos, basándonos en la frecuencia de estos. 

Con la entropía de Tsallis de los pases entre los jugadores, se puede medir la organización asociada al 
comportamiento de un equipo de fútbol \cite{entropy-analysis}.
