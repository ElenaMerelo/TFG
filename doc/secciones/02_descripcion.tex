...
entropía a nivel de jugador o equipo, empleando técnicas estadísticas para obtener respuestas a lo planteado y 
...
El desarrollo ágil tiene su origen en el manifesto ágil\cite{manifiesto-agil}, el cual fue una revolución frente 
...
Enunciamos ahora lo que son los modelos gráficos probabilísticos, ya que permiten realizar 
inferencias en dominios complejos dotados de incertidumbre.
...
\begin{itemize}
    ...
    \item Un conjunto de variables aleatorias $V={V_1...V_n}$ asociadas con los nodos del grafo $(\Omega, \mathbb{P})$ 
    de tal manera que $\mathbb{P}(V_1...V_n)= \prod_{i=1}^{n}\mathbb{P}(V_i|pa(V_i))$, donde $pa(V_i)$ es el 
    conjunto de los nodos padre del nodo $V_i$ en $\mathcal{G}$.  
\end{itemize}
\end{definicion}
...
aleatoria $V$ a sus modalidades ($V=v_1,..., V=v_n$ si $V$ puede tomar $n$ valores). Las aristas 
...
Vamos a ver un poco más específicamente lo que hemos llamado grafos.
