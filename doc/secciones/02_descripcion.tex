...
El objetivo de esta sección es definir los términos que serán usados en el estado del arte.

\begin{definicion}[Redes bayesianas]\label{def:BN}
Una red bayesiana es una representación 
...
predecir los datos perdidos o no observables.   
\end{definicion}
...
En la realidad, la mayor parte de los datos son una combinación de distribuciones 
