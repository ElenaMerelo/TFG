...
Permite llevar cuenta de los proyectos de Git, fuera del ordenador o 
servidor local, y está basado en la nube. A su vez, \href{https://git-scm.com/}{Git} es un 
...
\subsection{Como entrenador, me gustaría poder usar la herramienta desarrollada}
Y que sea intuitiva y fácil de usar.

\section{Milestones o Productos Mínimamente Viables}

\subsection{Milestone 1 - Infraestructura}
...
\begin{itemize}
    ...
    \item Definir los primeros milestones e issues.
...
\subsection{Milestone 2 - Planteamiento}
...
El objetivo de esta milestone es la recopilación de datos, procesarlos, eliminar los que 
