...
La historia del análisis de fútbol comienza en 1950, cuando Charles Reep\cite{reep-bio} empezó a 
...
posesiones de tres pases. Su trabajo mostró que "El 60 por ciento de todos los movimientos de gol 
comienzan a 32 metros de la portería de un oponente".
...
el punto de comienzo del análisis de fútbol moderno. 

En 2003, Michael Lewis lanzó el libro \href{https://en.wikipedia.org/wiki/Moneyball}{Moneyball}, el cual tuvo una gran 
influencia también fuera de Estados Unidos. Trata sobre cómo la oficina de \textit{Oakland Athletics} convertió 
un equipo de béisbol de bajo presupuesto en uno de los mejores, usando estadísticas para reclutar a jugadores 
con habilidades hasta entonces minusvaloradas. El lanzamiento del libro fomentó que se generaran preguntas en 
torno al uso de datos en el fútbol. Un par de irracionalidades del mercado de fichajes
quedaron expuestas, sobre todo la relación entre salario y duración de la carrera de los porteros
y delanteros y un extraño sesgo hacia la contratación de jugadores más altos.

Desde 2003 hasta ahora ha habido una revolución en el análisis de la organización 
...
de calificaciones dinámicas\cite{pi-ratings} y redes bayesianas híbridas para hacer una predicción del resultado de un 
