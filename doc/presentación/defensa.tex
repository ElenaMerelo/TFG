	...
	\begin{figure}
		\centering
		 ...
		 \subfloat[Entropía en el partido Inglaterra]{
		   \includegraphics[width=0.2\textwidth]{england_match_ordered.png}}
		 \subfloat[Entropía total Noruega]{
		   \includegraphics[width=0.2\textwidth]{norway_total_ordered.png}}
		\subfloat[Entropía total en el partido Noruega]{
			\includegraphics[width=0.2\textwidth]{norway_match_ordered.png}}
	   \end{figure}
\end{frame}
