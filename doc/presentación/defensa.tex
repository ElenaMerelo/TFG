...
\begin{frame}{Resultados}
	\begin{figure}
		\centering
			\subfloat[Entropía total de Inglaterra]{
			\includegraphics[width=0.5\textwidth]{englandentropy.png}}
			\subfloat[Entropía total de Noruega]{
			\includegraphics[width=0.5\textwidth]{norwayentrop.png}}
	\end{figure}
...
\begin{frame}{Preguntas}
	\begin{center}
		...
		\includegraphics[width=0.35\textwidth,keepaspectratio]{final.jpg}
    \end{center}
\end{frame}
